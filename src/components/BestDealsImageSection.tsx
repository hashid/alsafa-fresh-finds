...
export const BestDealsImageSection = () => {
  return <section className="py-12">
      <div className="container mx-auto px-6">
        <div className="bg-hypermarket-red rounded-2xl p-8 text-white shadow-2xl transform transition-all duration-1000 animate-fade-in opacity-0 translate-y-8" style={{
