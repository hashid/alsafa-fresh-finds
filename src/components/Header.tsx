      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h1 className="text-xl font-bold text-primary">Al Safa Hypermarket</h1>
              <p className="text-sm text-muted-foreground hidden sm:block">Seeb, Muscat</p>
            </div>
          </div>
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <Button 
              onClick={() => scrollToSection('contact')}
              className="bg-primary hover:bg-primary-dark text-white shadow-green"
            >
              Get Directions
            </Button>
          </nav>
        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 border-t border-border">
            <nav className="flex flex-col space-y-4">
              ...
              <Button 
                onClick={() => scrollToSection('contact')}
                className="bg-primary hover:bg-primary-dark text-white shadow-green w-full"
              >
                Get Directions
              </Button>
            </nav>
