        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h1 className="font-inter font-bold text-2xl md:text-3xl leading-none tracking-wide premium-3d-text transform hover:scale-105 transition-transform duration-300">
                <span className="text-red-500">AL SAFA</span>{' '}
