  ...
  return <div className="fixed inset-0 bg-white z-[9999] flex items-center justify-center">
      <div className="text-center space-y-8">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-premium-gold rounded-full animate-ping" style={{
          animationDelay: '0.5s'
        }}></div>
          <div className="absolute top-1 -left-4 w-2 h-2 bg-hypermarket-red rounded-full animate-ping" style={{
          animationDelay: '1s'
        }}></div>
        </div>
        ...
        <div className="relative w-48 h-16 mx-auto">
          ...
          <div className="absolute bottom-4 left-0 right-0 h-12 flex items-end justify-center gap-3 overflow-hidden">
            ...
            {progress > 10 && <div className="animate-bounce" style={{
            animationDelay: '0s'
          }}>
                <Apple className="w-8 h-8 text-fresh-green" />
              </div>}
            {progress > 25 && <div className="animate-bounce" style={{
            animationDelay: '0.2s'
          }}>
                <Carrot className="w-8 h-8 text-hypermarket-red" />
              </div>}
            {progress > 40 && <div className="animate-bounce" style={{
            animationDelay: '0.4s'
          }}>
                <Fish className="w-8 h-8 text-premium-gold" />
              </div>}
            {progress > 55 && <div className="animate-bounce" style={{
            animationDelay: '0.6s'
          }}>
                <Ham className="w-8 h-8 text-mustard-yellow" />
              </div>}
            {progress > 70 && <div className="animate-bounce" style={{
            animationDelay: '0.8s'
          }}>
        ...
        <div className="flex space-x-2 justify-center">
          ...
          <div className="w-2 h-2 bg-hypermarket-red rounded-full animate-bounce" style={{
          animationDelay: '0.1s'
        }}></div>
          <div className="w-2 h-2 bg-hypermarket-red rounded-full animate-bounce" style={{
          animationDelay: '0.2s'
