    ...
    <div className="fixed inset-0 bg-white z-[9999] flex items-center justify-center">
      <div className="text-center space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-charcoal-gray/70 font-medium">
        ...
        <div className="w-64 mx-auto">
          <div className="w-full bg-light-gray rounded-full h-2 overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-hypermarket-red to-hypermarket-red/80 rounded-full transition-all duration-300 ease-out"
              style={{ width: `${progress}%` }}
            ></div>
          </div>
          <p className="text-sm text-charcoal-gray/60 mt-2">{progress}%</p>
        </div>
