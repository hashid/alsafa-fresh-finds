...
export const ModernAbout = () => {
  ...
  const transitionImages = [aboutUsImage, frozenImage, fruitsImage, nidoImage, pocariImage, additionalProduct1, additionalProduct2, additionalProduct3, floorImage1, floorImage2, floorImage3, floorImage4, floorImage5];
