...
export const ModernHeader = () => {
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-white/50 backdrop-blur-sm shadow-soft">
      {/* Top contact bar */}
      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            <img src={logoAlSafa} alt="Al Safa Hypermarket" className="h-14 md:h-20 w-auto rounded-lg sleek-hover image-float" />
            {showTagline}
          </div>
