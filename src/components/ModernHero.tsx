            ...
            <div className="fade-in-up space-y-4" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="flex justify-center">
                <Button 
                  ...
                  className="bg-hypermarket-red hover:bg-hypermarket-red/90 text-white font-bold text-base md:text-lg rounded-lg w-32 md:w-44 h-12 md:h-14 px-5 md:px-7 py-3 md:py-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-2 animate-soft-blink"
                >
