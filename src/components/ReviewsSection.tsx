    ...
    <section id="reviews" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-ash-dark mb-4">
            What Our Customers Say
          </h2>
          <div className="w-20 h-1 bg-ash-dark mx-auto"></div>
        </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-ash-dark leading-relaxed mb-4 text-sm">
                          "{review.review}"
                        </p>
                        <div>
                          <p className="font-semibold text-ash-dark text-sm">{review.name}</p>
                          <p className="text-xs text-ash-dark">{review.location}</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="text-center mt-12">
          <Card className="bg-white border-primary/20 shadow-lg max-w-md mx-auto">
            <CardContent className="p-4 md:p-6">
              <h3 className="text-lg md:text-xl font-bold text-ash-dark mb-3">
                Get Exclusive Offers
              </h3>
              <div className="mb-4">
                <p className="text-ash-dark font-medium text-sm text-center">
